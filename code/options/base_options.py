...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', required=True, help='path to images (should have subfolders valA, valB, etc)')
        self.parser.add_argument('--valdataroot', help='path to images (should have subfolders valA, valB, etc)')
        ...
        self.parser.add_argument('--no_flip', default=True,action='store_true', help='if specified, do not flip the images for data augmentation')
