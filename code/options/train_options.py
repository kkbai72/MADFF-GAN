...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--continue_train',default=0, action='store_true', help='continue training: load the latest model')
        ...
        self.parser.add_argument('--niter_decay', type=int, default=120, help='# of iter to linearly decay learning rate to zero')
